        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className=" flex-col  lg:flex gap-2 w-full md:w-auto">
                <input
                  type="email"
                ...
                <button className="mt-4 md:mt-0  px-6 py-2 bg-linear-to-r from-gary-500 to-gray-600 text-white font-semibold rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all">
                  Subscribe
                </button>
              </div>
            </div>
