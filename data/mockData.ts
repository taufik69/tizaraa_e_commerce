...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "Ergonomic office chair with 3D lumbar support and adjustable armrests. Perfect for long working hours.",
    basePrice: 15999,
    rating: 4.5,
    reviewCount: 234,
    category: "Furniture",
...

  {
    ...
    description:
      "Electric height-adjustable standing desk with memory presets and anti-collision technology.",
    basePrice: 25999,
    rating: 4.8,
    reviewCount: 567,
    category: "Furniture",
...

  {
    ...
    description:
      "Dual monitor arm with gas spring technology, supports screens up to 32 inches.",
    basePrice: 4999,
    rating: 4.6,
    reviewCount: 892,
...

  {
    ...
    description:
      "7.1 Surround Sound wireless gaming headset with RGB lighting and 30-hour battery life.",
    basePrice: 8999,
    rating: 4.7,
    reviewCount: 1234,
...

  {
    ...
    description:
      "Hot-swappable mechanical keyboard with Cherry MX switches and per-key RGB lighting.",
    basePrice: 12999,
    rating: 4.9,
    reviewCount: 2103,
    category: "Electronics",
